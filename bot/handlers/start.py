...
async def cmd_start(message: types.Message):
    ...
    welcome_text = (
        ...
        "Я помогу тебе находить выгодные коэффициенты и value-ставки.\n\n"
        "<b>Что я умею:</b>\n"
        "• Сравнивать коэффициенты разных букмекеров\n"
        "• Находить value-ставки (завышенные коэффициенты)\n"
        "• Отправлять уведомления о выгодных предложениях\n"
        "• Показывать прогнозы экспертов\n\n"
